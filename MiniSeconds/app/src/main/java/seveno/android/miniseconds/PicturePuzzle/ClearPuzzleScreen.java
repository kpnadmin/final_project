...
public class ClearPuzzleScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initialTime = intent.getLongExtra("seveno.android.miniseconds.PicturePuzzle.ClearPuzzleScreen.puzzleTime",0);
        bubble_score = intent.getIntExtra("seveno.android.miniseconds.PicturePuzzle.ClearPuzzleScreen.tscore2", 0);
        elapsedTime = intent.getLongExtra("seveno.android.miniseconds.PicturePuzzle.ClearPuzzleScreen.elapsedTime",0);
