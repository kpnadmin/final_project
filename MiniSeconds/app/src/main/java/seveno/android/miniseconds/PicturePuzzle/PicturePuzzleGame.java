    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {//On first startup, creates the sequence, begins the timer and does some cleanup work.
         ...
         /*   intent.putExtra("seveno.android.miniseconds.PicturePuzzle.PuzzleGame.bubbleTime", timeTakenMillis);
            ...
            prevTime = intent.getLongExtra("seveno.android.miniseconds.PicturePuzzle.PuzzleGame.initialTime", 0);
            int puzzle_score = intent.getIntExtra("seveno.android.miniseconds.PicturePuzzle.PuzzleGame.tscore2", T_score);
            elapsedTime = intent.getLongExtra("seveno.android.miniseconds.PicturePuzzle.PuzzleGame.elapsedTime", elapsedTime);
    ...
    private void PlayNextGame() {
        ...
        Intent intent2 = new Intent(this, ClearPuzzleScreen.class);
         ...
         /*   intent.putExtra("seveno.android.miniseconds.PicturePuzzle.PuzzleGame.bubbleTime", timeTakenMillis);
            intent.putExtra("seveno.android.miniseconds.PicturePuzzle.PuzzleGame.tscore2", T_score);
            intent.putExtra("seveno.android.miniseconds.PicturePuzzle.PuzzleGame.elapsedTime", elapsedTime);*/
        intent2.putExtra("seveno.android.miniseconds.PicturePuzzle.ClearPuzzleScreen.puzzleTime", timeTakenMillis);
        T_score += 1000;
        intent2.putExtra("seveno.android.miniseconds.PicturePuzzle.ClearPuzzleScreen.tscore2", T_score);
        intent2.putExtra("seveno.android.miniseconds.PicturePuzzle.ClearPuzzleScreen.elapsedTime", elapsedTime);
